...
Electron React Desktop App with a premium dashboard for Bootstrap 4, Reactstrap and React. Argon Theme perfectly combines reusable HTML and React and modular CSS with a modern styling and beautiful markup throughout each HTML template in the pack.

#### Fully Coded Components

Bigberry TimeSheet App Dashboard in React is built with over 100 individual components. All components can take variations in colour, that you can easily modify using SASS files.
...
// run with electron: npm i -D electron electron-builder concurrently wait-on
// npm i cross-env electron-is-dev
// entry point to electron
public/electon.js =>
